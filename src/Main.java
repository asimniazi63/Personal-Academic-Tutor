...
public class Main {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 1148, 651);
	...
	public void tabs(){
		...
		tabbedPane.addTab("", c, new search());
		tabbedPane.setBackground(Color.WHITE);

		Icon d = new ImageIcon(Main.class.getResource("/images/1477787519_Database-Upload.png"));
		tabbedPane.addTab("", d, new Files());
		tabbedPane.setBackground(Color.WHITE);
		
//		Icon e = new ImageIcon(Main.class.getResource("/images/1477787330_Download-Computer.png"));
//		tabbedPane.addTab("", e, new downlaod());
//		tabbedPane.setBackground(Color.WHITE);

		Icon f = new ImageIcon(Main.class.getResource("/images/1477601863_Help.png"));
		tabbedPane.addTab("", f, new manual());
		tabbedPane.setBackground(Color.WHITE);
	}
